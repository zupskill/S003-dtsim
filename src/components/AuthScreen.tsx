    ...
    <div className="min-h-screen cyber-grid flex flex-col justify-between py-12 px-6 relative overflow-hidden select-none">
      ...
      <div className="w-full max-w-md mx-auto z-10 px-4 my-auto">
        <motion.div
          ...
          className="glass-panel rounded-2xl glow-cyan overflow-hidden p-8 border-brand-primary/25 text-left bg-background/85 backdrop-blur-lg relative"
        >
          {/* Ambient Glow */}
          <div className="absolute top-0 right-0 w-32 h-32 rounded-full blur-3xl pointer-events-none -mr-8 -mt-8 bg-brand-primary/10" />

          <div className="text-center mb-8">
            <span className="inline-flex items-center gap-2 px-3 py-1 border border-brand-primary/30 rounded-full text-brand-primary text-xs font-semibold mb-4 uppercase tracking-wider bg-brand-primary/20">
              <Sparkles className="w-3.5 h-3.5 text-brand-primary animate-pulse" /> GATEWAY PORTAL
            </span>
